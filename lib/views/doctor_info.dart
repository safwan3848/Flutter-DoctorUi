  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          padding: EdgeInsets.symmetric(horizontal: 12), //24
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              Row(
                children: <Widget>[
                  Image.asset("assets/doctor_pic2.png", height: 180), //220
                  SizedBox(
                    width: 20, //20
                  ),
                  Container(
                    width: MediaQuery.of(context).size.width - 165, //222
                    height: 160, //220
                    child: Column(
                  ...
                  Expanded(
                    child: Container(
                      padding: EdgeInsets.symmetric(
                          vertical: 24, horizontal: 16), //24 16
                      decoration: BoxDecoration(
